...
template = cv2.imread('C:/Python file/Handscan/hand_template.png', cv2.IMREAD_UNCHANGED)
if template is None:
    raise FileNotFoundError("Template image 'hand_template.png'")
...
# Looping untuk mendapatkan frame dari kamera
def overlay_image_alpha(img, img_overlay, pos):
    ...
    if img_overlay.shape[2] == 4:
        ...
        # If no alpha channel, just overwrite the region
        img[y:y+oh, x:x+ow] = img_overlay[:, :, :3]
